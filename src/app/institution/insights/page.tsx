...
export default function InstitutionInsightsPage() {
  ...
  const skillGaps: SkillGapItem[] = isDemoDean ? [
    {
      id: 'sql',
  ...
  const evaluatedStudentsCount = isDemoDean ? (isSmallCohort ? 4 : 100) : 0;
  const verifiedAttainmentsCount = isDemoDean ? (hasVerifiedSql ? 249 : 248) : 0;
  const targetRolesCount = isDemoDean ? 14 : 0;
  const criticalDeficitLabel = isDemoDean ? (hasVerifiedSql ? '-41%' : '-42%') : '0%';
      ...
      <div className="max-w-7xl mx-auto space-y-8 animate-fade-in pb-16">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="pb-card p-5 space-y-2">
            ...
            <div className="metric-value text-3xl text-text-primary">{evaluatedStudentsCount}</div>
          ...
          <div className="pb-card p-5 space-y-2">
            ...
            <div className="metric-value text-3xl text-success">{verifiedAttainmentsCount}</div>
            <p className="text-[10px] text-text-muted font-mono">{hasVerifiedSql && isDemoDean ? '+1 SQL attainment verified' : 'Faculty reviewed proofs'}</p>
          </div>
          ...
          <div className="pb-card p-5 space-y-2">
            ...
            <div className="metric-value text-3xl text-info">{targetRolesCount} Roles</div>
          ...
          <div className="pb-card p-5 space-y-2">
            ...
            <div className="metric-value text-3xl text-warning">{criticalDeficitLabel}</div>
            <p className="text-[10px] text-text-muted font-mono">SQL Level 3 ({isDemoDean ? (hasVerifiedSql ? 41 : 42) : 0} students)</p>
          </div>
        </div>
                  ...
                  <tr>
                    <td colSpan={6} className="px-5 py-8 text-center text-text-muted text-xs">
                      <div className="flex flex-col items-center justify-center gap-2">
                        <Users className="w-6 h-6 text-border-accent" />
                        <p>No verified curriculum data available yet.</p>
                        <p className="text-[10px]">Invite students and faculty to populate your radar.</p>
                      </div>
                    </td>
                  </tr>
                ) : skillGaps.map((item) => {
